...
//However, we need to provide two things to the PUT request for an upvote to go through: the post_id and the user_id. Fortunately, the user_id will be available on the session on the back end, but where is the post_id?
